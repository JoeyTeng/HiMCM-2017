...
if __name__ == '__main__':
    ...
    planet = loadCSV(sys.argv[1])
    star = numpy.array(loadCSV(sys.argv[2])).transpose()
    locus = shift(planet)
    ...
    json.dump(locus, open(sys.argv[3], 'w'))

    animate(locus, int(sys.argv[4]), (0, x_m - x), (0, y_m - y), (0, z_m - z))
